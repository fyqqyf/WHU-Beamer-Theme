...
%\usecolortheme{seagull}      % Outer color themes, 其他选择: whale, seahorse, dolphin . 换一个编译看看有什么不同.

\useinnertheme{circles}
%\usecolortheme{circles}     % Inner color themes, 其他选择: lily, orchid
\useinnertheme[shadow=false]{rounded} % 对 box 的设置: 圆角、有阴影.
\setbeamercolor{sidebar}{bg=WHUred!90} % sidebar的颜色
\definecolor{WHUred}{RGB}{161,47,47}  % use structure theme to change
%\setbeamercolor{background canvas}{bg=blue!9} % 背景色, 9%的蓝色. 去掉下一行, 试一试这个.
\setbeamertemplate{background canvas}[vertical shading][bottom=white,top=WHUred!25] %%背景色, 上25%的蓝, 过渡到下白.
